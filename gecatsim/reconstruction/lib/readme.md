...
# For Windows
in cmd, run `C:\Program Files\mingw64\bin\gcc.exe -Wall -O -g -fPIC -shared -o fdk_equiAngle.dll .\interface_fdk_angle.c `

`"C:\Program Files\mingw64\bin\gcc.exe" -Wall -O -g -fPIC -shared -o helicalrecon.dll .\Parallel_FDK_Helical_3DWeighting.c `

`"C:\Program Files\mingw64\bin\gcc.exe" -Wall -O -g -fPIC -shared -o Parallel_Axial_with_partialWeighting.dll .\Parallel_Axial_with_partialWeighting.c `
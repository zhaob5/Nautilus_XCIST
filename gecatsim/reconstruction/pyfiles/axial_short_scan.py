...
def load_C_recon_lib():
    ...
    if os.name == "nt":
        ...
        #lib_file = "Axial_Short_Scan.dll"
        lib_file = "Axial_Short_Scan_CUDA.dll"
    # else:
...
def axial_short_scan(cfg, prep):
    ...
    #Gamma_virtual = (BetaE - BetaS - np.pi)/2
    Gamma_m = DecAngle/2
    ...
    for i in range(ViewN):   
        ...
        for j in range(YL):
            ...
            UIndex          =  -(a/dYA)+YLC     ########## = (a/dYA)+YLC for simulation
